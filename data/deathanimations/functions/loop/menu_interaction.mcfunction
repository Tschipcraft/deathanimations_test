...
execute as @a if entity @s[scores={blood_local=3}] run tellraw @s ["",{"text":"[Death Animations]","color":"gray"},{"text":" Make sure to install the resource pack! (Update IS necessary from v1.3 to v1.4)","color":"aqua"}]
