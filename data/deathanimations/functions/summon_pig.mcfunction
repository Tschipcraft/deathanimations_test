...
summon minecraft:armor_stand ^ ^ ^ {Small:1b,Tags:[bodypart,pigbody,lame_bodypart],Silent:1,Invisible:1,DisabledSlots:4144959}
...
execute if score Global enable_drops matches 1 run loot spawn ~ ~ ~ loot minecraft:entities/pig
