...
execute as @e[type=#deathanimations:marker_entities,tag=visual,scores={age=35..},tag=OnGround,tag=!playerbody] unless entity @s[scores={age=145..150}] at @s unless entity @a[distance=..3] run function deathanimations:low_p_mode/activate
