...
execute as @s at @s run tp @s ~ ~ ~ 0 90
...
execute if score @s dy matches 0.. store result entity @s Motion[1] double 0.003 run scoreboard players get @s dy
execute if score @s dy matches ..0 store result entity @s Motion[1] double 0.001 run scoreboard players get @s dy
