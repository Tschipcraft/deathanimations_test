...
# Legs
execute as @s at @s positioned ~ ~0.10 ~ run summon minecraft:armor_stand ^0.15 ^ ^-0.15 {Small:1b,Tags:[bodypart,leg,sheepbody,bloody],Silent:1,Invisible:1,DisabledSlots:4144959}
...
# Torso
execute as @s at @s positioned ~ ~0.35 ~ run summon minecraft:armor_stand ^ ^ ^-0.2 {Small:1b,Tags:[bodypart,sheepbody,torso,bloody,big_torso],Silent:1,Invisible:1,DisabledSlots:4144959}
scoreboard players add @e[tag=bodypart] correction 1
...
# Head
execute as @s at @s positioned ~ ~0.35 ~ run summon minecraft:armor_stand ^ ^ ^ {Small:1b,Tags:[bodypart,sheepbody,head,bloody],Silent:1,Invisible:1,DisabledSlots:4144959}
scoreboard players add @e[tag=bodypart] correction 1
