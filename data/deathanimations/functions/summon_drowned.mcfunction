...
# Arms
execute as @s at @s if entity @s[scores={OnFire=0}] positioned ~ ~0.25 ~ run summon minecraft:armor_stand ^0.3 ^ ^0.3 {Small:1b,Tags:[bodypart,arm,watery,drownedcheck],Silent:1,Invisible:1,DisabledSlots:4144959}
...
# Legs
execute as @s at @s if entity @s[scores={OnFire=0}] positioned ~ ~0.10 ~ run summon minecraft:armor_stand ^0.15 ^ ^ {Small:1b,Tags:[bodypart,leg,drownedbody,watery],Silent:1,Invisible:1,DisabledSlots:4144959}
scoreboard players add @e[tag=bodypart] correction 1
...
# Torso
execute as @s at @s if entity @s[scores={OnFire=0}] positioned ~ ~0.30 ~ run summon minecraft:armor_stand ^ ^ ^ {Small:1b,Tags:[bodypart,drownedbody,torso,watery],Silent:1,Invisible:1,DisabledSlots:4144959}
scoreboard players add @e[tag=bodypart] correction 1
...
# Head
execute as @s at @s if entity @s[scores={OnFire=0}] positioned ~ ~0.50 ~ run summon minecraft:armor_stand ^ ^ ^ {Small:1b,Tags:[bodypart,drownedbody,head,watery],Silent:1,Invisible:1,DisabledSlots:4144959}
scoreboard players add @e[tag=bodypart] correction 1
...
## 1.15 & before:
#execute as @s at @s if entity @s[scores={OnFire=0}] positioned ~ ~0.20 ~ run summon minecraft:armor_stand ^ ^ ^ {NoAI:1,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1,tag:{display:{Name:"{\"text\":\"Drowned Head\",\"italic\":false}"},SkullOwner:{Id:"2f169660-61be-46bd-acb5-1abef9fe5731",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzNmN2NjZjYxZGJjM2Y5ZmU5YTYzMzNjZGUwYzBlMTQzOTllYjJlZWE3MWQzNGNmMjIzYjNhY2UyMjA1MSJ9fX0="}]}}}}],NoGravity:1,Tags:[visual,drownedbody,head,watery],Pose:{Head:[1f,1f,1f]},Silent:1,Invisible:1,DisabledSlots:4140800}
