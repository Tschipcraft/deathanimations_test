...
execute rotated ~ 0 positioned ~ ~-1.4 ~ run summon minecraft:armor_stand ^-0.0 ^0.06 ^-0.0 {CustomName:'{"text":"Tadpole Torso"}',Tags:[visual,init,dea_tadpole,torso,no_particle,da_bp_1.5x,da_bp_1.0y,da_bp_1.5z,da_bn_-1.5x,da_bn_-1.0y,da_bn_-1.5z],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{da_drop:1,CustomModelData:44,display:{Name:"{\"text\":\"Tadpole Torso\",\"italic\":false}"}}}],Pose:{Head:[1f,1f,1f],Body:[0f,90f,0f],LeftLeg:[180f,0f,0f],RightLeg:[180f,0f,0f]},Invisible:1b,Invulnerable:1b,NoBasePlate:1b,Silent:1b,NoGravity:1b,DisabledSlots:4140800,Rotation:[1f,0f]}
