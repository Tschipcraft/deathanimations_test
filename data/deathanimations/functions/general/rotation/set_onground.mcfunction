...
execute as @s[tag=!arm,tag=!head] if score @s rotation matches -45..45 run scoreboard players set @s rotation 1
execute as @s[tag=!arm,tag=!head] if score @s rotation matches 45..135 run scoreboard players set @s rotation 90
execute as @s[tag=!arm,tag=!head] if score @s rotation matches 135..220 run scoreboard players set @s rotation 180
execute as @s[tag=!arm,tag=!head] if score @s rotation matches -180..-135 run scoreboard players set @s rotation 180
execute as @s[tag=!arm,tag=!head] if score @s rotation matches -135..-45 run scoreboard players set @s rotation -90
...
execute as @s[tag=bow] if score @s rotation matches -90..90 run scoreboard players set @s rotation 10
execute as @s[tag=bow] if score @s rotation matches 90..180 run scoreboard players set @s rotation 190
execute as @s[tag=bow] if score @s rotation matches -180..-90 run scoreboard players set @s rotation 190

execute as @s[tag=item,tag=!bow] if score @s rotation matches -90..90 run scoreboard players set @s rotation 1
