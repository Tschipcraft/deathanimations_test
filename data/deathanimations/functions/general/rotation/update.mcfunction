##by Tschipcraft
# Updates the rotation of @s ( = visual entity)
...
execute as @s[tag=item] store result entity @s Pose.RightArm[1] float 1 run scoreboard players get @s rotation
execute as @s[tag=chestplate] store result entity @s Pose.Body[0] float -1 run scoreboard players get @s rotation

execute as @s store result entity @s Pose.Head[0] float 1 run scoreboard players get @s rotation
