...
execute as @s[tag=big_torso] if score @s rotation matches -180..-135 run tp @s ~ ~0.26 ~
...
# arm
execute as @s[tag=arm] if score @s rotation matches 45..135 run tp @s ~ ~0.26 ~
execute as @s[tag=arm] if score @s rotation matches -135..-45 run tp @s ~ ~0.26 ~
