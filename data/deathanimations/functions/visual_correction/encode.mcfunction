...
# head
execute as @s[tag=head] at @s if score @s rotation matches 135..220 run tp @s ~ ~0.57 ~
execute as @s[tag=head] at @s if score @s rotation matches -180..-135 run tp @s ~ ~0.57 ~
execute as @s[tag=head,tag=small_head] at @s if score @s rotation matches 135..220 run tp @s ~ ~0.171 ~
execute as @s[tag=head,tag=small_head] at @s if score @s rotation matches -180..-135 run tp @s ~ ~0.171 ~

execute as @s[tag=head] at @s if score @s rotation matches 45..135 run tp @s ~ ~0.26 ~
execute as @s[tag=head] at @s if score @s rotation matches -135..-45 run tp @s ~ ~0.26 ~
execute as @s[tag=head,tag=small_head] at @s if score @s rotation matches 45..135 run tp @s ~ ~0.078 ~
execute as @s[tag=head,tag=small_head] at @s if score @s rotation matches -135..-45 run tp @s ~ ~0.078 ~
