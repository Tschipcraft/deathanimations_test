...
summon zombie ~ ~-3 ~ {PersistenceRequired:1b,NoAI:1b,Tags:[Invisible,da_leg_test,exclude],Silent:1b,Invulnerable:1b,CanPickUpLoot:0b,IsBaby:1b,DeathLootTable:"minecraft:empty",DeathTime:19s,ActiveEffects:[{Id:14b,Amplifier:0b,Duration:40}]}
