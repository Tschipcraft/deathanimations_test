...
## Villager Type
scoreboard players add @e[tag=villager_death] Type 0
...
scoreboard players add @e[tag=zombie_villager_death] Type 0
...
## IsBaby
scoreboard players add @s[tag=zombie_death] IsSpecial 0
...
scoreboard players add @s[tag=husk_death] IsSpecial 0
...
scoreboard players add @s[tag=drowned_death] IsSpecial 0
