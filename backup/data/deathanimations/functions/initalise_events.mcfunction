...
execute as @s[type=player] as @e[type=arrow,nbt={inGround:0b},distance=..25] at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[arrow,d_a_p],Radius:0f,RadiusPerTick:0f,Duration:9}
